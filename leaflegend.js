...
(function() {
  var addChainedAttributeAccessor, root,
    __slice = [].slice;
  ...
  L.LeafLegend = L.Class.extend({
    ...
    makeGrid: function() {
      ...
      width = gridwidth;
      height = gridwidth;
      rectGrid = d3.layout.grid().bands().nodeSize([cell_width, cell_width]).padding([gutter_width, gutter_width]).cols([steps]).rows([steps]);
      if (legend_el === void 0) {
